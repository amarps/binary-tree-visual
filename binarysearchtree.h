...
public:
    ...
    void runPreorderTraversal(const T &);
    void stopPreorderTraversal(const T &);
...
template<typename T>
void BinarySearchTree<T>::stopPreorderTraversal(const T &item)
{
    // return false if duplicate...
...
template<typename T>
void BinarySearchTree<T>::runPreorderTraversal(const T &item)
{
    // return false if duplicate...
